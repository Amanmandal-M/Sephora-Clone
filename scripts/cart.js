...
let u1 = {
  ...
  Address:
    "Anandhu P A, Perumoola(H) Kailasanadu PO Pothakkally Idukky District Kerala, Kerala Idukki, Kerala - 685553 9526332548",
  cartItems: [
    {
      createdAt: "2022-12-10T04:24:59.885Z",
      image:
        "https://cdn13.nnnow.com/web-images/medium/styles/6QFRWWY6GN7/1589003350410/1.jpg",
      category: "Perfume",
    ...
    },
    {
      ...
      image:
        "https://cdn12.nnnow.com/web-images/medium/styles/SK7N1M9ICBQ/1583390837736/1.jpg",
      category: "Perfume",
    ...
    },
    {
      ...
      image:
        "https://cdn04.nnnow.com/web-images/medium/styles/JWDVPXLPG9P/1639113646812/1.jpg",
      category: "Perfume",
...
checkOutBtn.addEventListener("click", () => {
  window.location.replace("../html/shipping.html");
});
//shopMoreBtn
shopMoreBtn.addEventListener("click", () => {
  window.location.replace("../html/product1.html");
});
...
function renderCardItems(json) {
  ...
  let finalBeforeGST;
  if (subTotal != 0) {
    finalBeforeGST = subTotal - discount;
  } else {
    finalBeforeGST = subTotal;
  }
  ...
  if (subTotal >= 5000) {
    ...
    deliveryCharges = arr.length * 10 + 50;
  }
  if (subTotal == 0) {
    discount = 0;
    deliveryCharges = 0;
...
let cartItemCountIncreaseBtns = document.querySelectorAll(
  ".cartItemCountIncrease"
);
let cartItemCountDecreaseBtns = document.querySelectorAll(
